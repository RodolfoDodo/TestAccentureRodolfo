...
/********* TextField e TextArea ************/
	...
	public void subirArquivo() {
		...
		getDriver().findElement(By.id("picture")).sendKeys(Keys.ENTER);;
		
		  WebElement browse = getDriver().findElement(By.xpath("//*[@id=\"open\"]"));
		   //click on ‘Choose file’ to upload the desired file
		 browse.sendKeys("C:\\Users\\rodol\\Desktop\\Files\\Job Specification.txt"); //Uploading the file using sendKeys
